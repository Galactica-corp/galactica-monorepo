...
export default buildModule("RegistryStateSenderModule", (module) => {
  ...
  const maxMerkleRootsPerMessage = module.getParameter("maxMerkleRootsPerMessage", 50);

  const sender = module.contract("RegistryStateSender", [mailbox, registry, destinationDomain, maxMerkleRootsPerMessage]);
