 ...
 */
export const generateProof = async (proverData: any, dAppAddress: string, investigationInstitutionPubKey: [string, string]) => {
  ...
  const publicInput = {
    ...
    investigationInstitutionPubKey: investigationInstitutionPubKey,
