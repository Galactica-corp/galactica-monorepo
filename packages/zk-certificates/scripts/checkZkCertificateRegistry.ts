...
async function main() {
  ...
  const ZkCertificateRegistryAddress = '0xc2032b11b79B05D1bd84ca4527D2ba8793cB67b2';
  ...
  const GuardianRegistryAddress = await ZkCertificateRegistryInstance._GuardianRegistry();
