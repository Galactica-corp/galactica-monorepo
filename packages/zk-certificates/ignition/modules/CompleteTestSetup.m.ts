...
const CompleteTestSetupModule = buildModule(
  'CompleteTestSetupModule',
  (module) => {
    // Use all submodules
    ...
    module.call(infrastructure.guardianRegistry, 'grantGuardianRole', [
      deployer,
      institutionPubkeys.institutions.deployer.pubkey,
      guardianMetadata,
    ]);
