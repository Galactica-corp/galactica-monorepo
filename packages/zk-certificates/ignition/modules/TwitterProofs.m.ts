...
import gip3ZkCertRegistryModule from './zkCertRegistries/GIP3.m';
...
const TwitterProofsModule = buildModule('TwitterProofsModule', (module) => {
  ...
  // Parameters
  const { zkCertRegistry: twitterCertRegistry } = module.useModule(
  ...
  const creationTimeBefore2020SBT = {
    uri: module.getParameter(
      'creationTimeBefore2020Uri',
      'ipfs://QmNQCnW9QTnveNHr9aNsGWsHz3HBkCZ7x2XzQ2wehAiyAh',
    ),
    name: module.getParameter(
      'creationTimeBefore2020Name',
      'X created before 2020',
    ),
  ...
  const creationTimeIn2024SBT = {
    uri: module.getParameter(
      'creationTimeIn2024Uri',
      'ipfs://QmWtncmCSLKJBmmpntrQbeMFpUyUJEPsASacQfaVCQJobr',
    ),
  ...
  const followersCount100SBT = {
    uri: module.getParameter(
      'followersCount100Uri',
      'ipfs://Qmd8rVPsgdDa7ySCSnBbCYFFc6mGPzpX39rfLguWy8FQjQ',
    ),
  ...
  const followersCount1kSBT = {
    uri: module.getParameter(
      'followersCount1kUri',
      'ipfs://QmTt81xC3z9ZaYBV35rQAr3QkMNQD3wA5GaKE2JGf3FFxc',
    ),
  ...
  const followersCount10kSBT = {
    uri: module.getParameter(
      'followersCount10kUri',
      'ipfs://QmVALCT5SmMwxbSVdc28RwtnTuTPSr6srUftQCRbJiPUxZ',
    ),
  ...
  const zkpVerifierFollowersCount = module.contract(
  ...
  const followersCountSBT100 = module.contract(
    'VerificationSBT',
    [
    ...
    { id: 'DeployFollowersCountSBT100' },
  );

  const followersCountSBT1k = module.contract(
    'VerificationSBT',
    [
    ...
    { id: 'DeployFollowersCountSBT1k' },
  );

  const followersCountSBT10k = module.contract(
    'VerificationSBT',
    [
    ...
    { id: 'DeployFollowersCountSBT10k' },
  );

  // Configure SBTManager for followers count SBTs
  module.call(dAppSBTManager, 'setSBT', [0, followersCountSBT100], {
    id: 'SetSBT0',
  });
  module.call(
    dAppSBTManager,
    'setVerifierWrapper',
    [0, followersCountWrapper],
    { id: 'SetVerifierWrapper0' },
  );
  module.call(dAppSBTManager, 'setSBT', [1, followersCountSBT1k], {
    id: 'SetSBT1',
  });
  module.call(
    dAppSBTManager,
    'setVerifierWrapper',
    [1, followersCountWrapper],
    { id: 'SetVerifierWrapper1' },
  );
  module.call(dAppSBTManager, 'setSBT', [2, followersCountSBT10k], {
    id: 'SetSBT2',
  });
  module.call(
    dAppSBTManager,
    'setVerifierWrapper',
    [2, followersCountWrapper],
    { id: 'SetVerifierWrapper2' },
  );

  // Deploy CreationTime verifier and wrapper
  const zkpVerifierCreationTime = module.contract(
  ...
  const creationTimeSBTBefore2020 = module.contract(
    'VerificationSBT',
    [
    ...
    { id: 'DeployCreationTimeSBTBefore2020' },
  );

  const creationTimeSBTIn2024 = module.contract(
    'VerificationSBT',
    [
    ...
    { id: 'DeployCreationTimeSBTIn2024' },
  );

  // Configure SBTManager for creation time SBTs
  module.call(dAppSBTManager, 'setSBT', [3, creationTimeSBTBefore2020], {
    id: 'SetSBT3',
  });
  module.call(dAppSBTManager, 'setVerifierWrapper', [3, creationTimeWrapper], {
    id: 'SetVerifierWrapper3',
  });
  module.call(dAppSBTManager, 'setSBT', [4, creationTimeSBTIn2024], {
    id: 'SetSBT4',
  });
  module.call(dAppSBTManager, 'setVerifierWrapper', [4, creationTimeWrapper], {
    id: 'SetVerifierWrapper4',
  });
