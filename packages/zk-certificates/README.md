...
```shell
yarn hardhat createZkKYC --holder-file example/holderCommitment.json --kyc-data-file example/test.json --random-salt 1773 --registry-address 0xAbb654092b5BCaeca2E854550c5C972602eF7dA8 --network galaTestnet
```
