...
contract AgeProofZkKYC is Ownable {
    ...
    constructor(
        ...
        INDEX_CURRENT_YEAR = 8 + institutionKeyEntries;
        INDEX_CURRENT_MONTH = 9 + institutionKeyEntries;
        INDEX_CURRENT_DAY = 10 + institutionKeyEntries;
        INDEX_AGE_THRESHOLD = 11 + institutionKeyEntries;
    ...
    function setKYCRegistry(IZkCertificateRegistry newKYCRegistry)
        public
        onlyOwner
    {
